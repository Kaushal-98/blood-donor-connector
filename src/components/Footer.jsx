...
function Footer() {
  return (
    <footer className="border-t border-gray-100 dark:border-gray-800 mt-10 transition-colors">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-center gap-3 flex-wrap">
        <p className="flex items-center gap-1.5 text-sm text-subtext dark:text-gray-400">
          Made with <Heart size={14} className="text-coral" fill="currentColor" /> by
          <span className="text-coral font-semibold">Kaushal Sharma</span>
        </p>
  ...
  <a
    href="https://github.com/Kaushal-98"
    target="_blank"
    rel="noopener noreferrer"
